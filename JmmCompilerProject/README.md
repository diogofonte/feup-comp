# Compilers Project - GROUP 2D

| Name                                            | Work Distribution (%) |
|:------------------------------------------------|:---------------------:|
| Diogo Alexandre da Costa Melo Moreira da Fonte  |         33,33         |
| Carlos Alberto Ferreira Teles de Sousa          |         33,33         |
| Jorge Carlos Baptista Duarte                    |         33,33         |

Project Self-assessment: 18.5

Project Notes:
  - Implemented Semantic Analysis and Jasmin Generation in full, and almost all the OLLIR features;
  - Implemented all the three optimizations proposed:
     - Constant Folding
     - Constant Propagation
    - Register Allocation
  - ``iinc_min`` test from the ``section 5_optimizations`` doesn't pass because the ollir generates this code:
    ``` 
    tmp0.i32 :=.i32 i.i32 +.i32 1.i32; 
    i.i32 :=.i32 tmp0.i32;
    ```
